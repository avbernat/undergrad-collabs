...
dir_new = "/Users/anastasiabernat/Desktop/diagnostics/"
#setwd(dir)
...
sums = read.csv(paste0(inpath_new,"diagnostics_summary.csv"))
```
...
data = read.csv(paste0(inpath_new,"diagnostics_combos.csv")) 
data[order(data$set),]
```
